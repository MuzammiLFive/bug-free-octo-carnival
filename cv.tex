...
\item Modernized \textbf{Treasury Reporting tool} by redesigning the UI/UX and building an SPA using ReactJS in a \textbf{microfrontend} architecture deployed to GS Shell Payments Desktop.
...
\item Remediated \textbf{10+ Tech Risk items} (SQL injection, XSS, hard-coded secrets, RCE) using SAST and DAST tools, aligned with secure coding and DevOps best practices.
\end{joblong}

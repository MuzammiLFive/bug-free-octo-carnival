...
Frameworks & Spring Boot, ReactJS, Python Pandas, Web Components, JUnit, Mockito, Jest, cypress, Mocha, Chai \\
...
Tools \& Platforms & CI/CD (Jenkins, GitLab), IntelliJ, Co-Pilot, AWS S3, PCF, Git, Bitbucket, Nginx, Postman, Splunk, MariaDB, OAuth 2.0, JWT, JSON, XML, Web Accessibility \\
\end{tabularx}
%----------------------------------------------------------------------------------------
%   EDUCATION
%----------------------------------------------------------------------------------------
